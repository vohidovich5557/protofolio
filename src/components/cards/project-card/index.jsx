    ...
    return (
        <>
         <div className="w-[300px] h-[567px] lg:w-[349px] flex flex-col items-center justify-center shadow-lg shadow-gray-500 rounded-[15px] mb-[30px]" key={id} data-aos={aos} data-aos-duration="3000">
            ...
            <h3 className="text-center text-2xl text-secondary font-medium mb-[17px]">{title}</h3>
            <p className="text-center mb-[12px] text-md text-black/50">{text.slice(0, 135) + "..."}</p>
            ...
            <div className="flex items-center gap-[10px]">
                ...
                <a href={link} className="text-black decoration-2"><a href="https://giper-mart-kappa.vercel.app/">{linktext}</a></a>
            </div>
            <div className="flex items-center gap-[10px]">
                <img src={gitlink} alt="live" className="w-[15px] h-[15px]" />
                <a href={link2} className="text-black"><a href="https://github.com/vohidovich5557/GiperMart">{linktext2}</a></a>
            </div>
            </div>
            </div>
         </div>
